...
export const Row = ({ row, columns, selectedRows, onSelectRows, onSubmitChange, onEdit, onRowClick }: TRowProps) => {
  ...
  return (
    <Fragment>
      <Flex className={classes.container}>
        ...
        <List className={classes.list} onClick={() => onRowClick && onRowClick(row)}>
